...
import 'package:i18n_checker/src/command_runner.dart';
...
void main() {
  group('I18nCheckerCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late ProcessResult processResult;
    late I18nCheckerCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = I18nCheckerCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = I18nCheckerCommandRunner();
